...
def train(_class_, pars):
    ...
    for epoch in tqdm(range(1, num_epoch + 1)):
        ...
        print(
            'Epoch {}, Fusion {}, Sample Auroc: {:.4f}, Pixel Auroc:{:.4f}, Pixel Aupro: {:.4f}'.format(
                epoch, pars.fusion, auroc_sp, auroc_px, aupro_px
            )
        )
...
if __name__ == '__main__':
    ...
    for c in pars.classes:
        ...
        print(
            'Best score of class: {}, Fusion {}, Auroc sample: {:.4f}, Auroc pixel:{:.4f}, Pixel Aupro: {:.4f}'.format(
                c, pars.fusion, auroc_sp, auroc_px, aupro_px
            )
        )
